...
\maketitle
\abstract{The package provides a class for typesetting books to be published with AKA books series}
...
Put each chapter of a book in separate files
...
The \file{akabook.cls} class exploits \verb!enumitem! package for list environments 
